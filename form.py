...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_2 = QGroupBox(self.Preview)
        ...
        self.groupBox_3 = QGroupBox(self.Preview)
        ...
        self.groupBox_4 = QGroupBox(self.Preview)
        self.groupBox_4.setObjectName(u"groupBox_4")
        self.groupBox_4.setGeometry(QRect(510, 10, 451, 391))
        ...
        self.openbtn = QPushButton(self.Preview)
        self.openbtn.setObjectName(u"openbtn")
        self.openbtn.setGeometry(QRect(10, 50, 75, 41))
        self.groupBox_6 = QGroupBox(self.Preview)
        self.groupBox_6.setObjectName(u"groupBox_6")
        self.groupBox_6.setGeometry(QRect(510, 420, 461, 251))
        self.verticalLayoutWidget = QWidget(self.groupBox_6)
        self.verticalLayoutWidget.setObjectName(u"verticalLayoutWidget")
        self.verticalLayoutWidget.setGeometry(QRect(20, 29, 421, 201))
        self.dis_graph = QVBoxLayout(self.verticalLayoutWidget)
        self.dis_graph.setObjectName(u"dis_graph")
        ...
        self.groupBox.setGeometry(QRect(20, 140, 311, 361))
        self.verticalLayout = QVBoxLayout(self.groupBox)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.all_btn = QPushButton(self.groupBox)
        ...
        self.classi_btn = QPushButton(self.splitter)
        self.classi_btn.setObjectName(u"classi_btn")
        self.splitter.addWidget(self.classi_btn)
        self.reg_btn = QPushButton(self.splitter)
        self.reg_btn.setObjectName(u"reg_btn")
        self.splitter.addWidget(self.reg_btn)
        ...
        self.groupBox_7 = QGroupBox(self.Classify)
        self.groupBox_7.setObjectName(u"groupBox_7")
        self.groupBox_7.setGeometry(QRect(10, 30, 321, 80))
        self.comboBox = QComboBox(self.groupBox_7)
        self.comboBox.setObjectName(u"comboBox")
        self.comboBox.setGeometry(QRect(20, 40, 271, 22))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_6.setTitle(QCoreApplication.translate("MainWindow", u"distribution", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Preview), QCoreApplication.translate("MainWindow", u"Preview", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Preprocessing), QCoreApplication.translate("MainWindow", u"Preprocessing", None))
        self.groupBox.setTitle(QCoreApplication.translate("MainWindow", u"Algorithm", None))
        self.all_btn.setText(QCoreApplication.translate("MainWindow", u"All", None))
        self.classi_btn.setText(QCoreApplication.translate("MainWindow", u"Classification", None))
        self.reg_btn.setText(QCoreApplication.translate("MainWindow", u"Regression", None))
        ...
        self.groupBox_7.setTitle(QCoreApplication.translate("MainWindow", u"Dependent variable", None))
